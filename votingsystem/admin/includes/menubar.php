<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <!--Change logo of admin -->
      <li class=""><a href="admins.php"><i class="fa fa-users"></i> <span>Admin</span></a></li>
      <li class=""><a href="gradeandsection.php"><i class="fa fa-users"></i> <span>Grade & Section</span></a></li>
      <li class=""><a href="trackandstrand.php"><i class="fa fa-users"></i> <span>Track & Strand</span></a></li>
      <li class=""><a href="voters.php"><i class="fa fa-users"></i> <span>Voters</span></a></li>
      <li class=""><a href="partylist.php"><i class="fa fa-tasks"></i> <span>Partylist</span></a></li>
